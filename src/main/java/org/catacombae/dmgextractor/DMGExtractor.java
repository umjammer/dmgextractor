...
public class DMGExtractor {
    ...
    private static final Logger logger = getLogger(DMGExtractor.class.getName());
        ...
        try {
            ...
            if (ses != null && ses.graphical) {
                ...
                JOptionPane.showMessageDialog(null,
                        "The program encountered an uncaught exception:\n" + stackTrace +
    ...
    private static boolean extractProcedure(Session ses, UserInterface ui) throws Exception {

        ui.displayMessageVerbose("Processing: \"" + ses.dmgFile + "\"");

        ReadableRandomAccessStream dmgRaf = null;

        boolean sparseBundle;
...
//                        "trueOutOffset=" + trueOutOffset + " trueInOffset=" + trueInOffset};
                ...
                if (blockType == UDIFBlock.BT_ADC) {
                    ...
                    try {
                        ...
                        logger.log(Level.ERROR, de.getMessage(), de);
...
//                                "  CRITICAL. inSize and/or outSize are not 0!");
        ...
        if (ses.debug) {
            ...
            if (!merged.isEmpty() && merged.getFirst().getTrueInOffset() == 0)
            ...
            while (mergedIt.hasNext() || previous != null) {
                ...
                if (b == null || b.getTrueInOffset() > 0) {
                    ...
                    FileOutputStream curFos = new FileOutputStream(filename);
        ...
        try {
            ...
            if (i != args.length && (args.length - i) != emptyTrailingEntries) {
                ...
                if (ses.dmgFile.exists()) {
                    ...
                    if (i <= args.length - 1 && !args[i].trim().isEmpty())
