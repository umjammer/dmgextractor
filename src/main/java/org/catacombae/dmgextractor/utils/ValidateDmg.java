...
public class ValidateDmg {
    ...
    private static final Logger logger = getLogger(ValidateDmg.class.getName());
    ...
    public static ValidateResult validateKoly(RandomAccessFile sourceFile, Koly koly) throws IOException {
        ...
        String fourCCString = new String(Util.toByteArrayBE(koly.getFourCC()), StandardCharsets.US_ASCII);
        ...
        if (plistBegin1 > sourceFile.length())
            ...
            String xmlIdentifierString = new String(xmlIdentifier, StandardCharsets.US_ASCII);
