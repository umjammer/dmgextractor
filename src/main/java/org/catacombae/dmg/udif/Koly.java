...
public class Koly {
    ...
    private static final Logger logger = getLogger(Koly.class.getName());
    ...
    public int getFourCC() {
        return Util.readIntBE(fourCC);
    }

    public byte[] getUnknown1() {
        return Util.createCopy(unknown1);
    }

    public long getPlistBegin1() {
        return Util.readLongBE(plistBegin1);
    }

    public long getPlistEndSometimes() {
        return Util.readLongBE(plistEndSometimes);
    }

    public long getUnknown2() {
        return Util.readLongBE(unknown2);
    }

    public long getUnknown3() {
        return Util.readLongBE(unknown3);
    }

    public long getUnknown4() {
        return Util.readLongBE(unknown4);
    }

    public long getUnknown5() {
        return Util.readLongBE(unknown5);
    }

    public long getPossibleChecksumType() {
        return Util.readLongBE(possibleChecksumType);
    }

    public int getUnknown6() {
        return Util.readIntBE(unknown6);
    }

    public int getPossibleUnitSize() {
        return Util.readIntBE(possibleUnitSize);
    }

    public byte[] getUnknown7() {
        return Util.createCopy(unknown7);
    }

    public long getPlistBegin2() {
        return Util.readLongBE(plistBegin2);
    }

    public long getPlistSize() {
        return Util.readLongBE(plistSize);
    }

    public byte[] getUnknown8() {
        return Util.createCopy(unknown8);
    }

    public int getChecksumAlgorithm() {
        return Util.readIntBE(checksumAlgorithm);
    }

    public int getChecksumSize() {
        return Util.readIntBE(checksumSize);
    }

    public byte[] getChecksumData() {
        return Util.createCopy(checksumData);
    }
    ...
    public void printFields(PrintStream ps, String prefix) {
        ...
        if (bytesLeft > 0 && bytesLeft < 4) {
            logger.log(Level.DEBUG, "bytes left: " + bytesLeft);
    ...
    public static void main(String[] args) throws IOException {
        ...
        RandomAccessFile raf = new java.io.RandomAccessFile(args[0], "r");
